...
/**
 * Custom annotation to define pagination and sorting parameters for equipment-related API requests in OpenAPI documentation.
 * <p>
 ...
 *       Allowed values include "id", "exercise_name", and "equipment_name".</li>
 * </ul>
 * <p>
 * This annotation is processed at runtime and enhances API documentation for methods that handle paginated equipment queries.
 * <p>
 * <b>Example usage:</b>
 * <pre>{@code
 * @EquipmentPaginationRequestParameters
 * public PaginationResponseDTO<EquipmentResponseDTO> getEquipments(
...
@Parameters(
        value = {
                ...
                @Parameter(
                        ...
                        schema = @Schema(
                                type = "integer",
                                allowableValues = {"id", "exercise_name", "equipment_name"}
                        )
                )
        }
)
public @interface EquipmentPaginationRequestParameters {}
